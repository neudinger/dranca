module sodium.utils;
extern (D) auto SODIUM_C99(T)(auto ref T X)
{
        return X;
}
 ...
 */
extern (D) auto sodium_base64_ENCODED_LEN(T0, T1)(auto ref T0 BIN_LEN, auto ref T1 VARIANT)
{
...
void sodium_sub(ubyte* a, const(ubyte)* b, const size_t len);

char* sodium_bin2hex(char* hex, const size_t hex_maxlen, const ubyte* bin, const size_t bin_len);

int sodium_hex2bin(ubyte* bin, const size_t bin_maxlen, const char* hex,
                const size_t hex_len, const char* ignore, size_t* bin_len, const char** hex_end);

size_t sodium_base64_encoded_len(const size_t bin_len, const int variant);

char* sodium_bin2base64(char* b64, const size_t b64_maxlen, const ubyte* bin,
                const size_t bin_len, const int variant);

int sodium_base642bin(ubyte* bin, const size_t bin_maxlen, const char* b64,
                const size_t b64_len, const char* ignore, size_t* bin_len,
                const char** b64_end, const int variant);

int sodium_mlock(void* addr, const size_t len);

int sodium_munlock(void* addr, const size_t len);
...
int sodium_pad(size_t* padded_buflen_p, ubyte* buf, size_t unpadded_buflen,
                size_t blocksize, size_t max_buflen);
